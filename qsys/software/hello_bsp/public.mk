...
SOPCINFO_FILE := E:/1AAA/2_Verilog/cnc/qsys/hardware/qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9000
SOPC_SYSID_FLAG += --sidp=0x9000
ELF_PATCH_FLAG  += --sidp 0x9000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1623145252
SOPC_SYSID_FLAG += --timestamp=1623145252
ELF_PATCH_FLAG  += --timestamp 1623145252
