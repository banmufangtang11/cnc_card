...
(
    ...
    localparam PAD4 = log2ceil(64'h12030 - 64'h12020); 
    localparam PAD5 = log2ceil(64'h12040 - 64'h12030); 
    localparam PAD6 = log2ceil(64'h12050 - 64'h12040); 
    localparam PAD7 = log2ceil(64'h12058 - 64'h12050); 
    localparam PAD8 = log2ceil(64'h12060 - 64'h12058); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h12060;
    ...
    // ( 0x12030 .. 0x12040 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 17'h12030   ) begin
    ...
    // ( 0x12050 .. 0x12058 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 17'h12050  && read_transaction  ) begin
            src_channel = 9'b100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x12058 .. 0x12060 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 17'h12058   ) begin
