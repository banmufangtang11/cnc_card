...
// 与encode_pd的区别：delta_count和total_count使用加减运算(支持正负方向)
...
module encode_pd_a(
    ...
    // 计数输出
    output reg [31:0] delta_count,  // 增量计数(1ms周期内，可正可负)
    output reg [31:0] total_count   // 累计计数(总脉冲数，可正可负)
);
