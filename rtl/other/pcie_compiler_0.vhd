...
begin
  ...
  internal_clk125_out <= core_clk_out;
  pld_clk <= AvlClk_i;
  pcie_core_clk <= internal_clk125_out;
  ...
  gnd_CraWriteData_i <= std_logic_vector'("00000000000000000000000000000000");
  gnd_CraAddress_i <= std_logic_vector'("000000000000");
  gnd_CraByteEnable_i <= std_logic_vector'("0000");
  gnd_CraChipSelect_i <= std_logic'('0');
  gnd_CraRead <= std_logic'('0');
  gnd_CraWrite <= std_logic'('0');
  gnd_RxmIrq_i <= std_logic'('0');
  gnd_RxmIrqNum_i <= std_logic_vector'("000000");
...
-- Retrieval info:      <PRIVATE name = "SOPCSystemName" value="TEST"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "actualBAR0AvalonAddress" value="0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "actualBAR0Size" value="22"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "p_pci_bus_access_address_width" value="17"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "p_pci_impl_cra_av_slave_port" value="false"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "p_pcie_bar_size_bar_0" value="4 MBytes - 22 bits"  type="STRING"  enable="1" />
