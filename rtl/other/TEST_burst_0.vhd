...
--adapter is mastered by: dma_0/read_master
--adapter masters: dma_0/control_port_slave
--asp_debug: 0
--byteaddr_width: 7
--ceil_data_width: 32
--data_width: 32
...
end entity TEST_burst_0;


architecture europa of TEST_burst_0 is
                ...
                signal transactions_remaining :  STD_LOGIC_VECTOR (6 DOWNTO 0);
...
begin
  ...
  begin
    if reset_n = '0' then
      ...
      transactions_remaining <= A_EXT (A_WE_StdLogicVector((std_logic'(((upstream_read AND NOT internal_upstream_waitrequest))) = '1'), (((std_logic_vector'("0000000000000000000000000") & (upstream_burstcount)) - std_logic_vector'("000000000000000000000000000000001"))), (std_logic_vector'("0000000000000000000000000") & (A_WE_StdLogicVector((std_logic'((((internal_downstream_read AND NOT downstream_waitrequest) AND (or_reduce(transactions_remaining))))) = '1'), (((std_logic_vector'("0") & (transactions_remaining)) - (std_logic_vector'("0000000") & (A_TOSTDLOGICVECTOR(internal_downstream_burstcount))))), (std_logic_vector'("0") & (transactions_remaining)))))), 7);
    end if;
