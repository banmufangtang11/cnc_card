...
entity dma_0_read_data_mux is 
        port (
              -- inputs:
                 ...
                 signal dma_ctl_writedata : IN STD_LOGIC_VECTOR (20 DOWNTO 0);
                 ...
                 signal readaddress : IN STD_LOGIC_VECTOR (5 DOWNTO 0);
...
end entity dma_0_read_data_mux;


architecture europa of dma_0_read_data_mux is
...
entity dma_0_byteenables is 
        port (
              -- inputs:
                 ...
                 signal hw : IN STD_LOGIC;
                 signal word : IN STD_LOGIC;
                 signal write_address : IN STD_LOGIC_VECTOR (19 DOWNTO 0);

              -- outputs:
                 signal write_byteenable : OUT STD_LOGIC_VECTOR (7 DOWNTO 0)
              );
end entity dma_0_byteenables;


architecture europa of dma_0_byteenables is
...
entity dma_0_fifo_module_fifo_ram_module is 
        port (
              -- inputs:
                 signal clk : IN STD_LOGIC;
                 signal data : IN STD_LOGIC_VECTOR (63 DOWNTO 0);
                 signal rdaddress : IN STD_LOGIC_VECTOR (6 DOWNTO 0);
...
end entity dma_0_fifo_module_fifo_ram_module;


architecture europa of dma_0_fifo_module_fifo_ram_module is
              signal internal_q :  STD_LOGIC_VECTOR (63 DOWNTO 0);
              TYPE mem_array is ARRAY( 127 DOWNTO 0) of STD_LOGIC_VECTOR(63 DOWNTO 0);
              signal read_address :  STD_LOGIC_VECTOR (6 DOWNTO 0);

begin
   process (wrclock, clk) -- MG
        VARIABLE rd_address_internal : STD_LOGIC_VECTOR (6 DOWNTO 0) := (others => '0');

    VARIABLE wr_address_internal : STD_LOGIC_VECTOR (6 DOWNTO 0) := (others => '0');
...
end entity dma_0_fifo_module;


architecture europa of dma_0_fifo_module is
component dma_0_fifo_module_fifo_ram_module is 
           port (
                 -- inputs:
                    signal clk : IN STD_LOGIC;
                    signal data : IN STD_LOGIC_VECTOR (63 DOWNTO 0);
...
end component dma_0_fifo_module_fifo_ram_module;

                signal estimated_rdaddress :  STD_LOGIC_VECTOR (6 DOWNTO 0);
                signal estimated_wraddress :  STD_LOGIC_VECTOR (6 DOWNTO 0);
                ...
                signal p1_estimated_wraddress :  STD_LOGIC_VECTOR (6 DOWNTO 0);
                signal p1_fifo_empty :  STD_LOGIC;
                signal p1_wraddress :  STD_LOGIC_VECTOR (6 DOWNTO 0);
                signal rdaddress :  STD_LOGIC_VECTOR (6 DOWNTO 0);
                signal rdaddress_reg :  STD_LOGIC_VECTOR (6 DOWNTO 0);
                signal wraddress :  STD_LOGIC_VECTOR (6 DOWNTO 0);
                signal write_collision :  STD_LOGIC;

begin

  p1_wraddress <= A_EXT (A_WE_StdLogicVector((std_logic'((fifo_write)) = '1'), ((std_logic_vector'("00000000000000000000000000") & (wraddress)) - std_logic_vector'("000000000000000000000000000000001")), (std_logic_vector'("00000000000000000000000000") & (wraddress))), 7);
  process (clk, reset_n)
  begin
    if reset_n = '0' then
      wraddress <= std_logic_vector'("0000000");
    elsif clk'event and clk = '1' then
      if std_logic'(clk_en) = '1' then 
  ...
  rdaddress <= A_EXT (A_WE_StdLogicVector((std_logic'(flush_fifo) = '1'), std_logic_vector'("000000000000000000000000000000000"), A_WE_StdLogicVector((std_logic'(fifo_read) = '1'), (((std_logic_vector'("00000000000000000000000000") & (rdaddress_reg)) - std_logic_vector'("000000000000000000000000000000001"))), (std_logic_vector'("00000000000000000000000000") & (rdaddress_reg)))), 7);
  process (clk, reset_n)
  begin
    if reset_n = '0' then
      rdaddress_reg <= std_logic_vector'("0000000");
    elsif clk'event and clk = '1' then
  ...
  estimated_rdaddress <= A_EXT (((std_logic_vector'("00000000000000000000000000") & (rdaddress_reg)) - std_logic_vector'("000000000000000000000000000000001")), 7);
  p1_estimated_wraddress <= A_EXT (A_WE_StdLogicVector((std_logic'((inc_pending_data)) = '1'), ((std_logic_vector'("00000000000000000000000000") & (estimated_wraddress)) - std_logic_vector'("000000000000000000000000000000001")), (std_logic_vector'("00000000000000000000000000") & (estimated_wraddress))), 7);
  process (clk, reset_n)
  begin
    if reset_n = '0' then
      estimated_wraddress <= A_REP(std_logic'('1'), 7);
    elsif clk'event and clk = '1' then
      if std_logic'(clk_en) = '1' then 
        if std_logic'(flush_fifo) = '1' then 
          estimated_wraddress <= A_REP(std_logic'('1'), 7);
  ...
  dma_0_fifo_module_fifo_ram : dma_0_fifo_module_fifo_ram_module
    port map(
      q => fifo_ram_q,
      clk => clk,
      data => fifo_wr_data,
...
end entity dma_0_mem_read;


architecture europa of dma_0_mem_read is
                signal dma_0_mem_read_access :  STD_LOGIC;
                signal dma_0_mem_read_idle :  STD_LOGIC;
...
end entity dma_0_mem_write;


architecture europa of dma_0_mem_write is
...
--Mastered by:
--pcie_compiler_0/Rx_Interface; dma_0/read_master; 
--Read slaves:
--TEST_burst_0/upstream; 
--Write slaves:
--TEST_burst_1/upstream; 
...
entity dma_0 is 
        port (
              ...
              -- outputs:
                 ...
                 signal dma_ctl_readdata : OUT STD_LOGIC_VECTOR (20 DOWNTO 0);
                 signal dma_ctl_readyfordata : OUT STD_LOGIC;
                 signal read_address : OUT STD_LOGIC_VECTOR (5 DOWNTO 0);
                 signal read_burstcount : OUT STD_LOGIC_VECTOR (7 DOWNTO 0);
                 signal read_chipselect : OUT STD_LOGIC;
                 signal read_flush : OUT STD_LOGIC;
                 signal read_read_n : OUT STD_LOGIC;
                 signal write_address : OUT STD_LOGIC_VECTOR (19 DOWNTO 0);
                 signal write_burstcount : OUT STD_LOGIC_VECTOR (7 DOWNTO 0);
                 signal write_byteenable : OUT STD_LOGIC_VECTOR (7 DOWNTO 0);
...
attribute ALTERA_ATTRIBUTE of dma_0 : entity is "SUPPRESS_DA_RULE_INTERNAL=""R101""";
end entity dma_0;


architecture europa of dma_0 is
component dma_0_read_data_mux is 
           port (
                 -- inputs:
                    signal byte_access : IN STD_LOGIC;
                    signal clk : IN STD_LOGIC;
...
end component dma_0_read_data_mux;

component dma_0_byteenables is 
           port (
                 -- inputs:
                    signal byte_access : IN STD_LOGIC;
                    signal doubleword : IN STD_LOGIC;
...
end component dma_0_byteenables;

component dma_0_fifo_module is 
           port (
                 -- inputs:
                    signal clk : IN STD_LOGIC;
                    signal clk_en : IN STD_LOGIC;
...
end component dma_0_fifo_module;

component dma_0_mem_read is 
           port (
                 -- inputs:
                    signal clk : IN STD_LOGIC;
                    signal clk_en : IN STD_LOGIC;
...
end component dma_0_mem_read;

component dma_0_mem_write is 
           port (
                 -- inputs:
                    signal d1_enabled_write_endofpacket : IN STD_LOGIC;
                    signal fifo_datavalid : IN STD_LOGIC;
...
end component dma_0_mem_write;

                signal burst_read_waitrequest_s1 :  STD_LOGIC;
                signal burstcount :  STD_LOGIC_VECTOR (7 DOWNTO 0);
                signal burstcount_update :  STD_LOGIC_VECTOR (7 DOWNTO 0);
                ...
                signal p1_dma_ctl_readdata :  STD_LOGIC_VECTOR (20 DOWNTO 0);
                signal p1_done_read :  STD_LOGIC;
                signal p1_done_write :  STD_LOGIC;
                signal p1_fifo_full :  STD_LOGIC;
                signal p1_length :  STD_LOGIC_VECTOR (20 DOWNTO 0);
                signal p1_length_eq_0 :  STD_LOGIC;
                signal p1_read_got_endofpacket :  STD_LOGIC;
                signal p1_readaddress :  STD_LOGIC_VECTOR (5 DOWNTO 0);
                signal p1_write_got_endofpacket :  STD_LOGIC;
                signal p1_writeaddress :  STD_LOGIC_VECTOR (19 DOWNTO 0);
                signal p1_writelength :  STD_LOGIC_VECTOR (20 DOWNTO 0);
                ...
                signal readaddress :  STD_LOGIC_VECTOR (5 DOWNTO 0);
                ...
                signal writelength :  STD_LOGIC_VECTOR (20 DOWNTO 0);
...
begin
  ...
  --the_dma_0_read_data_mux, which is an e_instance
  the_dma_0_read_data_mux : dma_0_read_data_mux
    port map(
  ...
  --the_dma_0_byteenables, which is an e_instance
  the_dma_0_byteenables : dma_0_byteenables
    port map(
  ...
  begin
    if reset_n = '0' then
      burstcount_update <= std_logic_vector'("00000001");
    elsif clk'event and clk = '1' then
      if std_logic'(length_register_write) = '1' then 
        burstcount_update <= A_EXT (A_SRL(dma_ctl_writedata,std_logic_vector'("00000000000000000000000000000011")), 8);
      end if;
    end if;
  ...
  begin
    if reset_n = '0' then
      burstcount <= std_logic_vector'("00000001");
    elsif clk'event and clk = '1' then
  ...
  begin
    if reset_n = '0' then
      readaddress <= std_logic_vector'("000000");
    elsif clk'event and clk = '1' then
      if std_logic'(clk_en) = '1' then 
  ...
  p1_readaddress <= A_EXT (A_WE_StdLogicVector((std_logic'((((dma_ctl_chipselect AND NOT dma_ctl_write_n) AND to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000001"))))))) = '1'), dma_ctl_writedata, (std_logic_vector'("00000000000000") & (A_WE_StdLogicVector((std_logic'((inc_read)) = '1'), (((std_logic_vector'("0") & (readaddress)) + (std_logic_vector'("00") & (readaddress_inc)))), (std_logic_vector'("0") & (readaddress)))))), 6);
  -- write address
  process (clk, reset_n)
  begin
    if reset_n = '0' then
      writeaddress <= std_logic_vector'("00000000000000000000");
    elsif clk'event and clk = '1' then
      if std_logic'(clk_en) = '1' then 
  ...
  p1_writeaddress <= A_EXT (A_WE_StdLogicVector((std_logic'((((dma_ctl_chipselect AND NOT dma_ctl_write_n) AND to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000010"))))))) = '1'), dma_ctl_writedata, A_WE_StdLogicVector((std_logic'((inc_write)) = '1'), (((std_logic_vector'("0") & (writeaddress)) + (std_logic_vector'("0000000000000000") & (writeaddress_inc)))), (std_logic_vector'("0") & (writeaddress)))), 20);
  -- length in bytes
  process (clk, reset_n)
  begin
    if reset_n = '0' then
      length <= std_logic_vector'("000000000000000000000");
    elsif clk'event and clk = '1' then
      if std_logic'(clk_en) = '1' then 
        length <= p1_length;
      end if;
  ...
  p1_writelength <= A_EXT (A_WE_StdLogicVector((std_logic'((((dma_ctl_chipselect AND NOT dma_ctl_write_n) AND to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000011"))))))) = '1'), (std_logic_vector'("0") & (dma_ctl_writedata)), A_WE_StdLogicVector((std_logic'(((inc_write AND (NOT(writelength_eq_0))))) = '1'), ((std_logic_vector'("0") & (writelength)) - (std_logic_vector'("00000000000000000") & (Std_Logic_Vector'(A_ToStdLogicVector(std_logic'('0')) & A_ToStdLogicVector(doubleword) & A_ToStdLogicVector(word) & A_ToStdLogicVector(hw) & A_ToStdLogicVector(byte_access))))), (std_logic_vector'("0") & (writelength)))), 21);
  p1_writelength_eq_0 <= (inc_write AND (NOT(writelength_eq_0))) AND to_std_logic((((std_logic_vector'("0000000000") & ((((std_logic_vector'("0") & (writelength)) - (std_logic_vector'("00000000000000000") & (Std_Logic_Vector'(A_ToStdLogicVector(std_logic'('0')) & A_ToStdLogicVector(doubleword) & A_ToStdLogicVector(word) & A_ToStdLogicVector(hw) & A_ToStdLogicVector(byte_access)))))))) = std_logic_vector'("00000000000000000000000000000000"))));
  p1_length_eq_0 <= (inc_read AND (NOT(length_eq_0))) AND to_std_logic((((std_logic_vector'("0000000000") & ((((std_logic_vector'("0") & (length)) - (std_logic_vector'("0") & (length)))))) = std_logic_vector'("00000000000000000000000000000000"))));
  process (clk, reset_n)
  begin
    if reset_n = '0' then
  ...
  p1_dma_ctl_readdata <= (((((A_REP(to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000000")))), 21) AND (std_logic_vector'("0000000000000000") & (status)))) OR ((A_REP(to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000001")))), 21) AND (std_logic_vector'("000000000000000") & (readaddress))))) OR ((A_REP(to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000010")))), 21) AND (std_logic_vector'("0") & (writeaddress))))) OR ((A_REP(to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000011")))), 21) AND writelength))) OR ((A_REP(to_std_logic((((std_logic_vector'("00000000000000000000000000000") & (dma_ctl_address)) = std_logic_vector'("00000000000000000000000000000110")))), 21) AND (std_logic_vector'("00000000") & (control))));
  process (clk, reset_n)
  begin
    if reset_n = '0' then
      dma_ctl_readdata <= std_logic_vector'("000000000000000000000");
    elsif clk'event and clk = '1' then
      if std_logic'(clk_en) = '1' then 
  ...
  --the_dma_0_fifo_module, which is an e_instance
  the_dma_0_fifo_module : dma_0_fifo_module
    port map(
  ...
  the_dma_0_mem_read : dma_0_mem_read
    port map(
      inc_read => inc_read,
  ...
  --the_dma_0_mem_write, which is an e_instance
  the_dma_0_mem_write : dma_0_mem_write
    port map(
      fifo_read => fifo_read,
      inc_write => inc_write,
